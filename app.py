...
def model_prediction(test_image):
    model = tf.keras.models.load_model(r"/Users/aniketarora/Downloads/RESUME PROJECTS/PlantDisease/my_model.keras")
...
#Prediction Page
    ...
    test_image = st.file_uploader("Upload File", type=["png","jpg","jpeg"])
    if test_image:
        temp_dir = tempfile.mkdtemp()
        path = os.path.join(temp_dir, test_image.name)
    ...
    if(st.button("Predict")):
        ...
        result_index = model_prediction(path)
        #Reading Labels
